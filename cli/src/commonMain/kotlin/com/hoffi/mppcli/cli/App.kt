...
import com.hoffi.mppcli.cli.mappings.Buildspec
import com.hoffi.mppcli.cli.mappings.Nested
import com.hoffi.mppcli.lib.common.io.fs.fs
import com.hoffi.mppcli.lib.common.io.json.Generic
import com.hoffi.mppcli.lib.common.io.json.Pretty
import com.hoffi.mppcli.lib.common.io.json.collapseParentheses
import com.hoffi.mppcli.lib.common.io.mpp.Console
import com.hoffi.mppcli.lib.common.io.mpp.MppProcess
import com.hoffi.mppcli.lib.common.io.mpp.ProcessResult
import com.hoffi.mppcli.lib.common.io.mpp.executeCommand
...
//        echo()
    ...
    fun jsonYaml() {
        ...
        var input = fs.read("./data/buildspec.yml".toPath()) { readUtf8() }
        ...
        println("\n\n==== complex manual:")
        input = fs.read("./data/nested.json".toPath()) { readUtf8() }
        ...
        println("========================================")
        val jsonInput = fs.read("./data/buildspec.json".toPath()) { readUtf8() }
